...
Insert_Confirmed_Group_Booking_GFR(str(dt.date.today() - dt.timedelta(days=1)))
Insert_Confirmed_Group_Booking_GFR(str(dt.date.today() - dt.timedelta(days=2)))
Insert_Confirmed_Group_Booking_GFR(str(dt.date.today() - dt.timedelta(days=3)))

log_message("GFR - GFR  Inserting Api results from blocks done!")
import_date = dt.date.today() - dt.timedelta(days=3)
