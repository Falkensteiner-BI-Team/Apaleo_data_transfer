...
def Insert_API_Results(import_date):
    get_reservations = APIClient('https://api.apaleo.com/booking/v1/reservations?dateFilter=Departure&from=2024-09-01T00:00:00Z&to2024-10-01T00:00:00Z', get_token()).get_data()
