...
def Insert_Confirmed_Res():
    confirmed_services = APIClient(
        'https://api.apaleo.com/booking/v1/reservations/?dateFilter=Modification&from=' + str(
            dt.date.today() - dt.timedelta(days=7)) + 'T00:00:00Z&status=Confirmed&expand=timeSlices,services',
        get_token()).get_data()
...
def Insert_Inhouse_Res():
    get_reservations = APIClient(
        'https://api.apaleo.com/booking/v1/reservations?dateFilter=Modification&from=' + str(dt.date.today() - dt.timedelta(days=7)) + 'T00:00:00Z&status=Inhouse',
        get_token()).get_data()
...
def Insert_CheckedOut_Res():
    get_reservations = APIClient(
        'https://api.apaleo.com/booking/v1/reservations?dateFilter=Modification&from='+ str(dt.date.today() - dt.timedelta(days=7)) + 'T00:00:00Z&status=CheckedOut',
        get_token()).get_data()
...
def Insert_Canceled_NoShow_Res():
    confirmed_services = APIClient(
        'https://api.apaleo.com/booking/v1/reservations/?dateFilter=Modification&from=' + str(dt.date.today() - dt.timedelta(days=7)) + 'T00:00:00Z&status=Canceled,NoShow&expand=timeSlices,services',get_token()).get_data()
...
def Insert_Confirmed_Group_Booking_Folios():
    ...
    bookings = APIClient(
        'https://api.apaleo.com/booking/v1/blocks?expand=timeSlices&from=' +str(dt.date.today() - dt.timedelta(days=7)) + 'T00:00:00Z',
        get_token()).get_data()
