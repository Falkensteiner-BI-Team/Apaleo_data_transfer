...
def update_Inventory_Apaleo(import_date):
    properties = ["FCZ","FSA","FKP","FST","FHS","FHS","FBL"]
...
update_qry3 = """UPDATE V2I_ProtelHouseStatus_Apaleo  LEFT JOIN V2I_Inventory_Apaleo ON  PHS_code3 = IC_property SET PHS_rooms_available = PHS_amount_room - IC_ooo WHERE PHS_code3 = IC_property AND PHS_date =IC_date"""
update_qry4 = """UPDATE V2I_ProtelHouseStatus_Apaleo  LEFT JOIN V2I_Inventory_Apaleo ON  PHS_code3 = IC_property SET PHS_oos = IC_oos WHERE PHS_code3 = IC_property AND PHS_date = IC_date"""
